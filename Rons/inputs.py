...
class Inputs:
    ...
    def load_auxiliary_data(self, map_path: Path, echo: str) -> np.ndarray:
        """
        ...
        :return: Array of inflated echo of the auxiliary map
        """
